...
WANDB_PROJECT="magnrune-test-1"
WANDB_EXP_NAME="0.9-eng-nemotron--0.1-code-starcoder"
...
NUM_QUERY_GROUPS=16    # No GQA when NUM_QUERY_GROUPS=NUM_ATTENTION_HEADS
